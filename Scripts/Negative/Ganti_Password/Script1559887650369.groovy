...
driver.findElement(By.xpath("//input[@id='currentPassword']")).sendKeys("");
driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();
Thread.sleep(5000);
driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Customer Service'])[1]/following::span[1]")).click();
driver.findElement(By.xpath("//input[@id='newPassword']")).sendKeys("");
driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();

driver.findElement(By.xpath("//input[@id='confirmNewPassword']")).sendKeys("");
driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();

driver.findElement(By.xpath("//input[@id='currentPassword']")).sendKeys("IIwan12366");
driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();

driver.findElement(By.xpath("//input[@id='newPassword']")).sendKeys("IIEwan12345");
driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();

driver.findElement(By.xpath("//input[@id='confirmNewPassword']")).sendKeys("IIEwan123456");
driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();
